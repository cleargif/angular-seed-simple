 ...
 * WIP Banner
 */
console.log('material-design.min');
(function () {
  ...
  function MaterialRippleDirective(materialEffects, $interpolate, $throttle) {
    console.log('MaterialRippleDirective XX');
    return {
      restrict: 'E',
 ...
 */
  function TabDirective($attrBind, $compile, $timeout) {
    ...
    return {
      ...
      scope: true,
      link: linkTab,
      template: '<material-ripple initial-opacity="0.95" opacity-decay-velocity="0.89"> </material-ripple> ' +
        '<material-tab-label ' +
  ...
  function QpToastDirective() {
    return {
      restrict: 'E',
      transclude: true,
      template: '<div class="toast-container" ng-transclude>' +
        '</div>'
    };
  }
   ...
   *
   */
  .factory("$throttle", ['$timeout', '$$q', '$log',
          ...
          function invokeThrottleHandler(data, done) {
            ...
            if (angular.isFunction(phases.throttle)) {
              ...
              try {
                ...
                phases.throttle.apply(null, [data,
                  function (response) {
